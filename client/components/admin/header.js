...
import { logout } from '../../actions/admin/login-actions'
...
class Header extends Component {
  ...
  render() {
    const { toggleDropdownMenu, isMessagesMenuVisible, isProfileMenuVisible, isNotificationsMenuVisible } = this.props
    return (
                  ...
                  <div key={index}>
                    <Link className="dropdown-item preview-item" to="/">
                      ...
                      <div className="preview-item-content d-flex align-items-start flex-column justify-content-center">
                        <h6 className="fs-13 preview-subject ellipsis mb-1 font-weight-normal">{item.title}</h6>
                ...
                {notifications.map((item, index) => (
                  <div key={index}>
                    <Link className="dropdown-item preview-item" to="/">
                      ...
                      <div className="preview-item-content d-flex align-items-start flex-column justify-content-center">
                        <h6 className="fs-13 preview-subject font-weight-normal mb-1">{item.title}</h6>
...
const UserProfile = () => (
  <>
    ...
    <div className="nav-profile-text" data-name="Profile">
      <p className="mb-1 text-black" data-name="Profile">
        Varsha
      </p>
    </div>
  </>
...
const mapDispatchToProps = (dispatch) => bindActionCreators({ onLogout: logout }, dispatch)
